...
export function KkcpTree() {
  return (
    <div
      className="wp-singular page-template-default page page-id-1238 page-parent wp-theme-KKCP gsap-enable elementor-default elementor-template-full-width elementor-kit-14 elementor-page elementor-page-1238 e--ua-blink e--ua-mac e--ua-webkit"
      ...
      >
        ...
        <div className="loader-container">
          ...
          <div className="loader-icon">
            {" "}
            <img src="/about-us/assets/0030__Asset-2-11.webp" alt="KKCP" />{" "}
          </div>{" "}
        </div>
      </div>{" "}
      <div id="kkcp-page" className="kkcp-page-wrapper">
        ...
        <main id="kkcp-content" className="kkcp-content-wrapper">
          ...
          <div
            ...
            data-elementor-id={"1238"}
            className="elementor elementor-1238"
          >
            <div
              data-aos-once={"true"}
              className="elementor-element elementor-element-e208b96 e-flex e-con-boxed e-con e-parent e-lazyloaded"
              data-id={"e208b96"}
            ...
            >
              <div className="e-con-inner">
                <div
                  data-aos-once={"true"}
                  className="elementor-element elementor-element-daf6236 elementor-widget elementor-widget-rstb-breadcrumb"
                  data-id={"daf6236"}
                ...
                >
                  ...
                  <div className="rstb-breadcrumb">
                    ...
                    <span property="itemListElement">
                      ...
                      <meta property="url" content="/about-us/" />
                ...
                <div
                  data-aos-once={"true"}
                  className="elementor-element elementor-element-1a8fe64 elementor-widget elementor-widget-rstb-page-title"
                  data-id={"1a8fe64"}
                  data-element_type={"widget"}
                  data-e-type={"widget"}
                  data-widget_type={"rstb-page-title.default"}
                >
                  <h1 className="rstb-page-title">About Us</h1>
                </div>
                <div
                  data-aos-once={"true"}
                  className="elementor-element elementor-element-301e1fe elementor-widget elementor-widget-rs-divider"
                  data-id={"301e1fe"}
                  data-element_type={"widget"}
                  data-e-type={"widget"}
                ...
                <div
                  data-aos-once={"true"}
                  className="elementor-element elementor-element-052347e elementor-absolute gsap-move-yes down-90 start-10 elementor-hidden-mobile elementor-widget elementor-widget-rs-image"
                  data-id={"052347e"}
                  data-element_type={"widget"}
                  data-e-type={"widget"}
                ...
                >
                  ...
                  <div className="rs-image">
                    ...
                    <img
                      ...
                      src="/about-us/assets/0043__bnr-arrow-1-1.webp"
                      alt="bnr-arrow-1-1"
                    />{" "}
                  </div>
                </div>
            ...
            <div
              data-aos-once={"true"}
              className="elementor-element elementor-element-5b5f096 e-flex e-con-boxed e-con e-parent e-lazyloaded"
              data-id={"5b5f096"}
              data-element_type={"container"}
              data-e-type={"container"}
              data-settings={'{"background_background":"classic"}'}
            >
              <div className="e-con-inner">
                <div
                  data-aos-once={"true"}
                  className="elementor-element elementor-element-e73c7bf e-con-full e-flex e-con e-child"
                  data-id={"e73c7bf"}
                  data-element_type={"container"}
                  data-e-type={"container"}
                  data-settings={'{"background_background":"classic"}'}
                >
                  <div
                    data-aos-once={"true"}
                    className="elementor-element elementor-element-4408fe5 e-con-full e-flex e-con e-child"
                    data-id={"4408fe5"}
                    data-element_type={"container"}
                    data-e-type={"container"}
                    data-settings={'{"background_background":"classic"}'}
                  >
                    <div
                      data-aos-once={"true"}
                      className="elementor-element elementor-element-6bcb6b9 elementor-widget-mobile__width-inherit elementor-widget elementor-widget-rs-heading"
                      data-id={"6bcb6b9"}
                      data-element_type={"widget"}
                      data-e-type={"widget"}
                    ...
                    <div
                      data-aos-once={"true"}
                      className="elementor-element elementor-element-cf653dd elementor-widget elementor-widget-rs-divider"
                      data-id={"cf653dd"}
                      data-element_type={"widget"}
                      data-e-type={"widget"}
                      data-widget_type={"rs-divider.default"}
                    ...
                    <div
                      data-aos-once={"true"}
                      className="elementor-element elementor-element-a60e831 elementor-widget elementor-widget-rstb-nav-menu"
                      data-id={"a60e831"}
                      data-element_type={"widget"}
                      data-e-type={"widget"}
                    ...
                    >
                      {" "}
                      <div className="rstb-nav-menu nav-vertical nav-breakpoint-none ">
                        <ul id="menu-main-menu" className="primary-menu">
                          ...
                          <li className="menu-item menu-item-type-custom menu-item-object-custom">
                            <a href="/campus" className="menu-item-link">
                          ...
                          <li className="menu-item menu-item-type-custom menu-item-object-custom">
                            <a href="/scholarships" className="menu-item-link">
                              <span className="menu-item-text">
                                Scholarships
                              </span>
                            </a>
                          ...
                          <li className="menu-item menu-item-type-custom menu-item-object-custom">
                            <a href="/testimonials/" className="menu-item-link">
                              <span className="menu-item-text">
                                Testimonials
                              </span>
                            </a>
                    ...
                    <div
                      data-aos-once={"true"}
                      className="elementor-element elementor-element-dea6d42 elementor-widget elementor-widget-rs-image"
                      data-id={"dea6d42"}
                      data-element_type={"widget"}
                      data-e-type={"widget"}
                      data-widget_type={"rs-image.default"}
                    >
                      ...
                      <div className="rs-image">
                        ...
                        <img
                          decoding="async"
                          className="rs-multi-image  reverse- blend_unset"
                          src="/about-us/assets/0057__about-sidebar-thumb.webp"
                          alt="about-sidebar-thumb"
                        />{" "}
                      </div>
                    </div>
                  </div>
                ...
                <div
                  data-aos-once={"true"}
                  className="elementor-element elementor-element-8ec17cb e-con-full e-flex e-con e-child"
                  data-id={"8ec17cb"}
                  data-element_type={"container"}
                  data-e-type={"container"}
                >
                  <div
                    data-aos-once={"true"}
                    className="elementor-element elementor-element-29525cf elementor-widget elementor-widget-rs-heading"
                    data-id={"29525cf"}
                    data-element_type={"widget"}
                    data-e-type={"widget"}
                    data-widget_type={"rs-heading.default"}
                    ...
                    <div className="prelements-heading default   animate-  ">
                      ...
                      <div className="descripti">
                        <p className="text-justify">
                          Established in 1992, K.K. College of Pharmacy
                          experienced significant development under the dynamic
                          leadership of Prof. KR. Arumugam, a distinguished
                          educationlist and academician who served in
                          prestigious roles as a member of the Senate and
                          Governing Council for the Tamilnadu Dr. M.G.R. Medical
                          University. Initially providing Diploma and Degree
                          courses in Pharmacy, the institution quickly attained
                          full-fledged recognition as a Pharmacy College status
                          including Masters and Ph.D. programs, all located in
                          the charming city of Chennai. The campus features a
                          tranquil setting positioned at Gerugambakkam on
                  ...
                  <div
                    data-aos-once={"true"}
                    className="elementor-element elementor-element-c1f2a30 elementor-widget elementor-widget-rs-heading"
                    data-id={"c1f2a30"}
                    data-element_type={"widget"}
                    data-e-type={"widget"}
                    data-widget_type={"rs-heading.default"}
                  >
                    {" "}
                    <div className="prelements-heading default center  animate-  ">
                      {" "}
                      <div className="title-inner">
                        <h3 className="title  ">
                  ...
                  <div
                    data-aos-once={"true"}
                    className="elementor-element elementor-element-0e5c84e e-con-full e-flex e-con e-child"
                    data-id={"0e5c84e"}
                    data-element_type={"container"}
                    data-e-type={"container"}
                    style={{
                  ...
                  >
                    ...
                    >
                      <img
                        decoding="async"
                        src="/about-us/assets/mgr-university.webp"
                        alt="The Tamil Nadu Dr. M.G.R. Medical University, Chennai"
                        style={{
                          height: "120px",
                          width: "auto",
                          objectFit: "contain",
                      ...
                      >
                        Affiliated with The Tamil Nadu Dr. M.G.R. Medical
                        University, Chennai.
                      </p>
                    </div>
                    <div
                    ...
                    >
                      <img
                        decoding="async"
                        src="/about-us/assets/pharmacy-council.webp"
                        alt="Pharmacy Council of India, New Delhi"
                        style={{
                          height: "120px",
                          width: "auto",
                          objectFit: "contain",
                    ...
                    >
                      <img
                        decoding="async"
                        src="/about-us/assets/tamilnadu-govt.webp"
                  ...
                  <div
                    data-aos-once={"true"}
                    className="elementor-element elementor-element-7a2aa52 e-con-full e-flex e-con e-child"
                    data-id={"7a2aa52"}
                    data-element_type={"container"}
                    data-e-type={"container"}
                  >
                    <div
                      data-aos-once={"true"}
                      className="elementor-element elementor-element-323b155 elementor-widget elementor-widget-rs-image"
                      data-id={"323b155"}
                      data-element_type={"widget"}
                      data-e-type={"widget"}
                      data-widget_type={"rs-image.default"}
                    >
                      ...
                      <div className="rs-image">
                        ...
                        <img
                          decoding="async"
                          className="rs-multi-image  reverse- blend_unset"
                          src="/kkcp/web/about/img-0344.webp"
                          alt="Pharmacy students in uniform walking together along a corridor at K.K. College of Pharmacy"
                        />{" "}
                      </div>
                    </div>
                    <div
                      data-aos-once={"true"}
                      className="elementor-element elementor-element-bf875fe elementor-widget elementor-widget-rs-image"
                      data-id={"bf875fe"}
                      data-element_type={"widget"}
                      data-e-type={"widget"}
                      data-widget_type={"rs-image.default"}
                    >
                      ...
                      <div className="rs-image">
                        ...
                        <img
                          decoding="async"
                          className="rs-multi-image  reverse- blend_unset"
                          src="/kkcp/web/about/img-0394.webp"
                          alt="Group of K.K. College of Pharmacy students giving a thumbs-up together on campus"
                        />{" "}
                      </div>
                    </div>
                  </div>
                  ...
                  <div
                    data-aos-once={"true"}
                    className="elementor-element elementor-element-dfde0d5 e-con-full e-flex e-con e-child"
                    data-id={"dfde0d5"}
                    data-element_type={"container"}
                    data-e-type={"container"}
                    data-settings={'{"background_background":"classic"}'}
                  >
                    <div
                      data-aos-once={"true"}
                      className="elementor-element elementor-element-80f3123 elementor-widget elementor-widget-rs-counter"
                      data-id={"80f3123"}
                      data-element_type={"widget"}
                      data-e-type={"widget"}
                      data-widget_type={"rs-counter.default"}
                    >
                      {" "}
                        ...
                        <div className="rs-counter-list">
                          ...
                          <div className="count-text">
                            ...
                            <div className="count-number">
                              {" "}
                              {/* <span className="id-80f3123 rs-counter odometer odometer-theme-default">
                    ...
                    <div
                      data-aos-once={"true"}
                      className="elementor-element elementor-element-a74aedf elementor-hidden-mobile elementor-widget elementor-widget-rs-divider"
                      data-id={"a74aedf"}
                      data-element_type={"widget"}
                      data-e-type={"widget"}
                      data-widget_type={"rs-divider.default"}
                    ...
                    <div
                      data-aos-once={"true"}
                      className="elementor-element elementor-element-b181972 elementor-widget elementor-widget-rs-counter"
                      data-id={"b181972"}
                      data-element_type={"widget"}
                      data-e-type={"widget"}
                      data-widget_type={"rs-counter.default"}
                      ...
                      <div className="counter-top-area">
                        ...
                        <div className="rs-counter-list">
                          ...
                          <div className="count-text">
                            ...
                            <div className="count-number">
                              {" "}
                              {/* <span className="id-b181972 rs-counter odometer odometer-theme-default">
                                <div className="odometer-inside">
                                  <span className="odometer-digit">
                                    <span className="odometer-digit-spacer">
                                      8
                    ...
                    <div
                      data-aos-once={"true"}
                      className="elementor-element elementor-element-18a8001 elementor-hidden-mobile elementor-widget elementor-widget-rs-divider"
                      data-id={"18a8001"}
                      data-element_type={"widget"}
                      data-e-type={"widget"}
                      data-widget_type={"rs-divider.default"}
                    ...
                    <div
                      data-aos-once={"true"}
                      className="elementor-element elementor-element-cbaa0be elementor-widget elementor-widget-rs-counter"
                      data-id={"cbaa0be"}
                      data-element_type={"widget"}
                      data-e-type={"widget"}
                      data-widget_type={"rs-counter.default"}
                      ...
                      <div className="counter-top-area">
                        ...
                        <div className="rs-counter-list">
                          ...
                          <div className="count-text">
                            ...
                            <div className="count-number">
                              {" "}
                              {/* <span className="id-cbaa0be rs-counter odometer odometer-auto-theme">
                                <div className="odometer-inside">
                                  <span className="odometer-digit">
                                    <span className="odometer-digit-spacer">
                                      8
                            ...
                            <span className="title">Industry Tie-Ups</span>{" "}
                          </div>{" "}
                        </div>{" "}
                      </div>{" "}
                    </div>
                  ...
                  <div
                    data-aos-once={"true"}
                    className="elementor-element elementor-element-d50b9bf elementor-widget elementor-widget-rs-heading"
                    data-id={"d50b9bf"}
                    data-element_type={"widget"}
                    data-e-type={"widget"}
                    data-widget_type={"rs-heading.default"}
                  >
                    {" "}
                    <div className="prelements-heading default center ">
                      {" "}
                      <div className="title-inner">
                        <h3 className="title  ">
                  ...
                  <div
                    data-aos-once={"true"}
                    className="elementor-element elementor-element-0bdfebf e-con-full e-flex e-con e-child"
                    data-id={"0bdfebf"}
                    data-element_type={"container"}
                    data-e-type={"container"}
                  >
                    <div
                      data-aos-once={"true"}
                      className="elementor-element elementor-element-2cb9203 e-con-full e-flex e-con e-child min-h-75!"
                      data-id={"2cb9203"}
                      data-element_type={"container"}
                      data-e-type={"container"}
                      data-settings={'{"background_background":"classic"}'}
                    >
                      <div
                        data-aos-once={"true"}
                        className="elementor-element elementor-element-34b7aa2 elementor-view-default elementor-position-block-start elementor-mobile-position-block-start elementor-widget elementor-widget-icon-box"
                        data-id={"34b7aa2"}
                        data-element_type={"widget"}
                        data-e-type={"widget"}
                      ...
                      <div
                        data-aos-once={"true"}
                        className="elementor-element elementor-element-6e6b4b1 elementor-widget elementor-widget-rs-heading"
                        data-id={"6e6b4b1"}
                        data-element_type={"widget"}
                        data-e-type={"widget"}
                        data-widget_type={"rs-heading.default"}
                      >
                        ...
                        <div className="prelements-heading default center  ">
                          ...
                          <div className="descripti">
                            <p>
                              To establish ourselves as a leading Pharmacy
                              College, providing specialized education that
                              aligns with industry standards and clinical
                              practice that promotes academic excellence.
                            </p>{" "}
                          </div>{" "}
                        </div>
                      </div>
                    ...
                    <div
                      data-aos-once={"true"}
                      className="elementor-element elementor-element-5832af2 e-con-full e-flex e-con e-child min-h-75!"
                      data-id={"5832af2"}
                      data-element_type={"container"}
                      data-e-type={"container"}
                      data-settings={'{"background_background":"classic"}'}
                    >
                          ...
                          <div className="elementor-icon-box-icon">
                            <span className="elementor-icon">
                              <svg
                                ...
                                fill="currentColor"
                              >
                                <path d="M12 2a10 10 0 100 20 10 10 0 000-20zm0 3.5a6.5 6.5 0 110 13 6.5 6.5 0 010-13zm0 3A3.5 3.5 0 1012 15.5 3.5 3.5 0 0012 8.5zm0 2A1.5 1.5 0 1112 13.5 1.5 1.5 0 0112 10.5z" />
                              </svg>
                            </span>
                          </div>
                        </div>
                      ...
                      >
                        ...
                        <div className="prelements-heading default center  animate-  ">
                          ...
                          <div className="descripti">
                            <p>
                              To deliver high-quality Pharmacy Education,
                              cultivate strong moral values &amp; produce
                              graduates equipped with leadership skills and
                              professionalism, contributing to societal
                  ...
                  <MessageSlider
                    cards={[
                      {
                        photo: MANAGEMENT_PORTRAITS["Chairman"],
                        name: "Prof. K.R. Arumugam, M.Pharm.,",
                        role: `Chairman<br />Ultra Group of Institutions`,
                        title: "Chairman’s Message",
                        body: `It brings me immense pride and joy to speak to all of you as the Chairman of this distinguished institution. First and foremost, I want to convey my heartfelt appreciation for the steadfast support each of you has provided in transforming our college into a center of knowledge and character. I take pride in stating that we transcend traditional subject teaching to impart essential life lessons to our students.<br /><br />One of my fundamental beliefs is that humility is intrinsically linked to success. I encourage all our students to stay humble, respect their elders, and value humility in every aspect of their lives. These principles are crucial not only for individual development but also for fostering strong and harmonious relationships with others.<br /><br />Attendance and punctuality are the foundations of success, and I urge every student to attend classes consistently. By being present and engaging actively in the learning process, you will lay the groundwork for a brighter future.<br /><br />At our college, we recognize the significance of practical experience in the real world. Therefore, we ensure that our students gain substantial industrial exposure, which acts as a bridge between theory and practice, preparing them to be industry-ready and adaptable to the constantly changing demands of the professional landscape.<br /><br />We are dedicated to offering our students a wide range of placement opportunities. Our partnerships with reputable companies and organizations guarantee that our graduates enter the job market with confidence and competence. We take great pride in seeing our alumni excel in their respective fields and make a lasting impact wherever they go. Let us appreciate this dynamic and supportive learning environment and make the most of it. Together, we can create a better future for ourselves and for the world.`,
                      },
                      {
                        photo: MANAGEMENT_PORTRAITS["Vice-Chairman"],
                        name: "Dr. A. Babu Thandapani, M.Pharm., Ph.D.,",
                        role: `Vice-Chairman<br />Ultra Group of Institutions`,
                        title: "Vice-Chairman’s Message",
                        body: `Our institution boasts a world-class infrastructure and cutting-edge laboratories. Our faculty is highly qualified and committed, providing invaluable support to students in their pursuit of knowledge through these facilities. We regard our faculty as the most significant asset of our institution. Our commitment to serving and uplifting society will persist in the future, expanding in scope and impact.`,
                      },
                      {
                        photo: MANAGEMENT_PORTRAITS["Principal"],
                        name: "Dr. A. Meena, M.Pharm., Ph.D.,",
                        role: `Principal<br />K.K. College of Pharmacy`,
                        title: "Principal’s Message",
                        body: `I am delighted to connect with you via the website on behalf of K.K. College of Pharmacy.<br /><br />K.K. College of Pharmacy boasts spacious laboratories and is equipped with the most advanced instruments available. We take pride in our highly qualified, experienced, and dedicated teaching staff.<br /><br />I firmly believe that Pharmacists play a crucial role in the production of high-quality medicines. It is with great pride that we state K.K. College of Pharmacy offers exceptional educational training and a diverse array of opportunities for our students to advance their careers.`,
                      },
                      {
                        photo: MANAGEMENT_PORTRAITS["Dean of Academics"],
                        name: "Dr. A. Shanthi, M.Pharm., Ph.D.,",
                        role: `Dean of Academics<br />K.K. College of Pharmacy`,
                        title: "Dean's Message",
                        body: `Dear students, staff, and visitors,<br /><br />It is with immense joy that I extend a warm welcome to all of you on our college website! As the Vice-Principal of this prestigious institution, I am privileged to engage with you today and share the core values and principles that we uphold here at our college.<br /><br />As you explore our website, I am confident that you will be impressed by the variety of programs and activities available at K.K. College of Pharmacy (KKCP). More importantly, what distinguishes us is our steadfast dedication to hard work, perseverance, and discipline. We believe these attributes are fundamental to a successful academic experience, and we encourage all our students to incorporate these traits into their everyday lives. Whether through our academic curriculum or extracurricular activities, we aim to instill these values in every one of our students.<br /><br />In my role as Vice-Principal, I am committed to ensuring that every student graduates from our institution not only with a degree but also with the skills and mindset necessary to thrive in any career path they choose. In this endeavor, we are fortunate to have a team of devoted faculty and staff who are focused on delivering the highest quality education and support to our students.<br /><br />Therefore, whether you are a prospective student, a parent, or simply browsing our website, I encourage you to take a closer look at what we have to offer. I am confident that you will discover something that resonates with you and that will instill pride in being part of our college community.`,
                      },
                    ]}
                  />
                </div>
            ...
            <div
              data-aos-once={"true"}
              className="elementor-element elementor-element-8e16336 e-con-full e-flex e-con e-child"
              data-id={"8e16336"}
              data-element_type={"container"}
              data-e-type={"container"}
            >
              <div
                data-aos-once={"true"}
                className="elementor-element elementor-element-c7e05fe elementor-widget-tablet__width-initial elementor-widget elementor-widget-rs-image"
                data-id={"c7e05fe"}
                data-element_type={"widget"}
                data-e-type={"widget"}
                data-widget_type={"rs-image.default"}
              >
                ...
                <div className="rs-image">
                  ...
                  <img
                    decoding="async"
                    className="rs-multi-image  reverse- blend_unset"
                    src="/about-us/assets/0062__gallery-img1-min.webp"
                    alt="gallery-img1-min"
                  />{" "}
                </div>
              </div>
              <div
                data-aos-once={"true"}
                className="elementor-element elementor-element-532b9c3 elementor-widget-tablet__width-initial elementor-widget elementor-widget-rs-image"
                data-id={"532b9c3"}
                data-element_type={"widget"}
                data-e-type={"widget"}
                data-widget_type={"rs-image.default"}
              >
                ...
                <div className="rs-image">
                  ...
                  <img
                    decoding="async"
                    className="rs-multi-image  reverse- blend_unset"
                    src="/about-us/assets/0063__gallery-img2-min.webp"
                    alt="gallery-img2-min"
                  />{" "}
                </div>
              </div>
              <div
                data-aos-once={"true"}
                className="elementor-element elementor-element-1fa0651 elementor-widget-tablet__width-initial elementor-widget elementor-widget-rs-image"
                data-id={"1fa0651"}
                data-element_type={"widget"}
                data-e-type={"widget"}
                data-widget_type={"rs-image.default"}
              >
                ...
                <div className="rs-image">
                  ...
                  <img
                    decoding="async"
                    className="rs-multi-image  reverse- blend_unset"
                    src="/about-us/assets/0064__gallery-img3-min.webp"
                    alt="gallery-img3-min"
                  />{" "}
                </div>
              </div>
              <div
                data-aos-once={"true"}
                className="elementor-element elementor-element-e273335 elementor-widget-tablet__width-initial elementor-widget elementor-widget-rs-image"
                data-id={"e273335"}
                data-element_type={"widget"}
                data-e-type={"widget"}
                data-widget_type={"rs-image.default"}
              >
                ...
                <div className="rs-image">
                  ...
                  <img
                    decoding="async"
                    className="rs-multi-image  reverse- blend_unset"
                    src="/about-us/assets/0065__gallery-img4-min.webp"
              ...
              <div
                data-aos-once={"true"}
                className="elementor-element elementor-element-862928f elementor-widget-tablet__width-initial elementor-widget elementor-widget-rs-image"
                data-id={"862928f"}
                data-element_type={"widget"}
                data-e-type={"widget"}
                data-widget_type={"rs-image.default"}
              >
                ...
                <div className="rs-image">
                  ...
                  <img
                    decoding="async"
                    className="rs-multi-image  reverse- blend_unset"
                    src="/about-us/assets/0067__gallery-img5-5-min.webp"
              ...
              <div
                data-aos-once={"true"}
                className="elementor-element elementor-element-c3a0894 elementor-widget-tablet__width-initial elementor-widget elementor-widget-rs-image"
                data-id={"c3a0894"}
                data-element_type={"widget"}
                data-e-type={"widget"}
                data-widget_type={"rs-image.default"}
              >
                ...
                <div className="rs-image">
                  ...
                  <img
                    decoding="async"
                    className="rs-multi-image  reverse- blend_unset"
                    src="/about-us/assets/0066__gallery-img6-min.webp"
