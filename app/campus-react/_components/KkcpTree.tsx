...
const CAMPUS_FILTERS = [
  {
    ...
    label: "1 Campus → Smart-Class Rooms",
    href: "#smart-class-rooms",
  },
  { id: "laboratory", label: "2 Campus → Laboratory", href: "#laboratory" },
  {
    id: "animal-house-facility",
    label: "3 Campus →Animal House Facility",
    href: "#animal-house-facility",
  },
...
const FACILITIES = [
  ...
  },
  {
    ...
    blocks: [
      {
        type: "p",
        text: "The Animal House at our institution is a meticulously maintained and ethically operated facility designed to facilitate pre-clinical and pharmacological research endeavors. It offers a regulated environment for the care and upkeep of laboratory animals utilized in scientific studies.",
      },
      {
        type: "p",
        text: "Our facility adheres rigorously to the guidelines set forth by the Committee for Control and Supervision of Experiments on Animals (CCSEA), Government of India (Registration No. 1395/a/10/CPCSEA), guaranteeing the utmost standards of animal welfare and ethical adherence.",
      },
    ],
  },
  {
    ...
    blocks: [
      ...
      {
        type: "p",
        text: "Our college library serves as a heaven for knowledge seekers, featuring a vast array of books across numerous disciplines, such as Pharmaceutics, Pharmacy Practice, Pharmacognosy, Pharmaceutical Analysis, Pharmaceutical Chemistry, Community Pharmacy, Clinical & Pharmacology, Hospital Pharmacy, Pharmaceutical Regulatory Affairs and Computer Science.",
      },
      {
        type: "p",
        text: "We offer a diverse selection of national and international journals, along with subscription to e-Journals. The library is equipped with broadband internet access and Wi-Fi, ensuring students can easily connect to resources.",
      },
      {
        type: "p",
        text: "Our library creates a tranquil atmosphere that promotes learning and intellectual development. Our dedicated librarian and faculty members are always ready to support students with their research needs.",
      },
      {
        type: "p",
        text: "Additionally, the library is equipped with modern facilities, including computer terminals and printers. We invite you to explore our extensive collection, enjoy the joys of reading & uncover new knowledge at our college library.",
      },
    ],
  },
  {
    ...
    blocks: [
      {
        type: "p",
        text: "The institute has a foolproof security system in place. There is a strong emphasis on maintaining a stringent security protocol throughout the campus. The entire college grounds are monitored by CCTV cameras, and we have highly trained security personnel stationed at the college entrance.",
      },
      {
        type: "p",
        text: "In total, there are 84 state-of-the-art Hikvision cameras that provide top-notch recording quality. These measures assist in observing student behavior and ensuring their safety and security.",
      },
    ],
  },
  {
    ...
    blocks: [
      ...
      {
        type: "p",
        text: "Our college provides convenient transportation services that link students to different areas of the city.",
      },
      {
        type: "p",
        text: "We guarantee that students arrive at their destinations safely and punctually with skilled and timely drivers.",
      },
      {
        type: "p",
        text: "Our fleet of well-kept buses is outfitted with contemporary safety features, such as GPS tracking and CCTV cameras, ensuring peace of mind for both students and their parents.",
      },
      {
        type: "p",
        text: "From morning pickups to evening drop-offs, our transportation system emphasizes comfort, safety and dependability, demonstrating our dedication to student convenience.",
      },
    ],
  },
];
...
function Block({ block }) {
  if (block.type === "label")
    return <h5 className="dept-label">{block.text}</h5>;
  if (block.type === "bullet")
    return <p className="dept-text dept-bullet">{block.text}</p>;
          ...
          >
            ...
            >
              <div className="e-con-inner">
                ...
                >
                  <div className="rstb-breadcrumb">
                    ...
                    <span property="itemListElement">
                      ...
                      <meta property="url" content="/campus/" />
                ...
                >
                  <h1 className="rstb-page-title">Campus</h1>
                </div>
                <div
                ...
                <div
                  className="elementor-element elementor-element-419a788 elementor-widget__width-initial elementor-widget elementor-widget-text-editor"
                  data-id={"419a788"}
                  data-element_type={"widget"}
                    ...
                    <div className="filter-content">
                      <div className="filter-top-bar">
                        ...
                        <span className="filter-result">
                          Total <span className="result-count">6</span> results
                          found
                        </span>
        ...
        "
          ...
          "
              ...
              "
                              ...
                              {/* DESCRIPTION */}
                              <div className="item-desc dept-desc text-justify">
            ...
            <div
              className="elementor-element e-flex e-con-boxed e-con e-parent accomplished-section"
              data-element_type={"container"}
            >
              <div className="e-con-inner">
          ...
          <style>{`
            /* kkcp-root sets overflow-y:auto which establishes a scroll container and
            ...
            .kkcp-root { overflow-x: clip; overflow-y: visible; }
